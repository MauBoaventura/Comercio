...
namespace OiMundo {
    ...
    public partial class MercadoDataSet : global::System.Data.DataSet {
        ...
        public partial class tbClienteDataTable : global::System.Data.TypedTableBase<tbClienteRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public tbClienteRow AddtbClienteRow(int Id, string Nome, string Telefone) {
...
namespace OiMundo.MercadoDataSetTableAdapters {
    ...
    public partial class tbClienteTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[tbCliente] WHERE (([Id] = @Original_Id) AND ((@IsNull_Nome = 1" +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[tbCliente] ([Id], [Nome], [Telefone]) VALUES (@Id, @Nome, @Tel" +
                "efone);\r\nSELECT Id, Nome, Telefone FROM tbCliente WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[tbCliente] SET [Id] = @Id, [Nome] = @Nome, [Telefone] = @Telefone WHERE (([Id] = @Original_Id) AND ((@IsNull_Nome = 1 AND [Nome] IS NULL) OR ([Nome] = @Original_Nome)) AND ((@IsNull_Telefone = 1 AND [Telefone] IS NULL) OR ([Telefone] = @Original_Telefone)));
SELECT Id, Nome, Telefone FROM tbCliente WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Nome, Telefone FROM dbo.tbCliente";
        ...
        public virtual int Fill(MercadoDataSet.tbClienteDataTable dataTable) {
        ...
        public virtual MercadoDataSet.tbClienteDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            MercadoDataSet.tbClienteDataTable dataTable = new MercadoDataSet.tbClienteDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(MercadoDataSet.tbClienteDataTable dataTable) {
        ...
        public virtual int Insert(int Id, string Nome, string Telefone) {
        ...
        public virtual int Update(int Id, string Nome, string Telefone, int Original_Id, string Original_Nome, string Original_Telefone) {
        ...
        public virtual int Update(string Nome, string Telefone, int Original_Id, string Original_Nome, string Original_Telefone) {
            return this.Update(Original_Id, Nome, Telefone, Original_Id, Original_Nome, Original_Telefone);
        }
    }
